...
| [Polytoken](https://polytoken.dev/) | ✅ Verified (Haiku live loop) | Native Anthropic Messages client — `X-Polytoken-Session` identity, mandatory client-owned tools (passthrough cannot be disabled), signed-thinking passthrough; see [Polytoken](docs/agents.md#polytoken) |
